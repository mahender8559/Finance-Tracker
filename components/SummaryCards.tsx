...
interface Props { expenses: number; investments: LedgerEntry; savings: LedgerEntry; stats: OverallStats; netFlow: number; }
...
export function SummaryCards({ expenses, investments, savings, stats, netFlow }: Props) {
  return <section aria-label="Monthly summary" className="mb-6 grid grid-cols-1 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-md dark:border-slate-700 dark:bg-slate-900 sm:grid-cols-2 md:mb-8 md:flex">
