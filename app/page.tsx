...
export default function Dashboard() {
  ...
  const _plannedActualKeys = Array.from(new Set([...Object.keys(plannedByCategory), ...Object.keys(actualByCategory)]));
