export type LedgerType = 'Income' | 'Planned Expense' | 'Actual Expense' | 'Future Purchases' | 'Billed Credit Card' | 'Unbilled Credit Card' | 'Summary' | 'IDFC Breakdown';
...
export type PaymentMethod = 'Cash' | 'UPI' | 'Credit Card' | 'Debit Card' | 'Bank Transfer' | 'Wallet';
